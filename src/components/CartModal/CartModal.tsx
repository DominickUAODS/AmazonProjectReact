					...
					<div className={styles.cartModalHeader}>
						<div className={styles.cartModalHeaderTitle}>
							<svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M5 7.17969H8.8C12.15 7.17969 11.19 11.8897 10.71 13.9197C10.06 16.6497 10.26 19.5597 13.51 20.3497C14.16 20.5097 14.83 20.5597 15.49 20.5597H27.03C27.03 20.5597 27.35 20.5597 27.83 20.6197C31.22 21.0297 30.96 25.4697 27.55 25.4997C27.51 25.4997 27.46 25.4997 27.42 25.4997H14.47" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
								<path d="M15.0303 8.29004H33.3203C34.6503 8.29004 35.4503 9.78004 34.7103 10.89L30.0603 17.86" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
								<path d="M16.2603 32.8204C17.4919 32.8204 18.4903 31.8219 18.4903 30.5904C18.4903 29.3588 17.4919 28.3604 16.2603 28.3604C15.0287 28.3604 14.0303 29.3588 14.0303 30.5904C14.0303 31.8219 15.0287 32.8204 16.2603 32.8204Z" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
								<path d="M27.4097 32.8204C28.6413 32.8204 29.6397 31.8219 29.6397 30.5904C29.6397 29.3588 28.6413 28.3604 27.4097 28.3604C26.1781 28.3604 25.1797 29.3588 25.1797 30.5904C25.1797 31.8219 26.1781 32.8204 27.4097 32.8204Z" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
							</svg>
						...
						<svg onClick={onClose} width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path d="M34.94 34.8699L21.5 21.4399" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
							<path d="M5.05957 5L17.4996 17.44C18.8796 18.82 18.8796 21.06 17.4996 22.44L5.05957 34.88" stroke="#0E2042" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
						</svg>
					</div>
