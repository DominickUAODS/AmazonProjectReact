                ...
                <div className={styles.aoB}>
                    <div className={styles.aoB0}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19.3619 6.88716C20.3699 8.33916 20.9579 10.0972 20.9579 11.9992C20.9579 16.9492 16.9439 20.9632 11.9939 20.9632C7.04391 20.9632 3.02991 16.9492 3.02991 11.9992C3.02991 7.04916 7.04391 3.03516 11.9939 3.03516C13.3439 3.03516 14.6219 3.33516 15.7679 3.86916" stroke="#0E2042" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.01428 12.6185L10.2663 14.9465C10.8723 15.2345 11.5863 15.1565 12.1143 14.7545L19.3683 6.89453" stroke="#0E2042" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    ...
                    <div  className={styles.aoB1}>
                        <div className={styles.aoB1Button}>
                            ...
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.58398 1.92188L10.9 7.46587C11.24 7.81787 11.24 8.37788 10.9 8.72988L5.58398 14.2579" stroke="#4A7BD9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
