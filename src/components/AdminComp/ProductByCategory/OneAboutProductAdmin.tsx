...
import styles from './OneAboutProductAdmin.module.css'
...
export default function OneAboutProductAdmin({
	feature,
	onNameChange,
	onDescriptionChange,
	onDelete,
	...
	return (
		<div className={styles.oneProp}>
			...
			<fieldset className={`${commonStyles.inputWrapper} ${styles.inputDesc}`}>
