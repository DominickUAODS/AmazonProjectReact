    ...
    <div className={styles.plHeader}>
      <div className={styles.productCheck}>
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.1128 16.3809L12.5168 20.7909C12.2228 21.0729 11.7608 21.0729 11.4668 20.7909L6.88281 16.3869" stroke="#0E2042" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M17.1128 7.61955L12.5168 3.20955C12.2228 2.92755 11.7608 2.92755 11.4668 3.20955L6.88281 7.61355" stroke="#0E2042" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
