									...
									<div className={photo_styles.gallery}>
										...
										<div className={photo_styles.addPhoto} onClick={() => fileInputRef.current?.click()}>
											<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M24 5.92773V20.9157" stroke="#4A7BD9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
												<path d="M41.9997 23.9277H27.0117" stroke="#4A7BD9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
												<path d="M6 23.9277H20.988C22.656 23.9277 24 25.2717 24 26.9397V41.9277" stroke="#4A7BD9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
											</svg>
										</div>
